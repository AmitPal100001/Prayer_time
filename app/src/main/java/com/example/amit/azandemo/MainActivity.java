package com.example.amit.azandemo;
...
String a="";
    ...
    public void onLocationChanged(Location location) {
        ...
        mLastUpdateTime = DateFormat.getTimeInstance().format(new Date());
        updateUI();
        Toast.makeText(this, "getLatitudegetLatitude  "+mCurrentLocation.getLatitude() +"   getLongitude  "+mCurrentLocation.getLongitude(), Toast.LENGTH_SHORT).show();
    }
